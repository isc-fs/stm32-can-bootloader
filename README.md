...
> **Start here:** read [ARCHITECTURE.md](ARCHITECTURE.md) for the memory map, boot flow and firmware contract. Everything application firmware must honour to be flashed and launched by this bootloader is defined there.
