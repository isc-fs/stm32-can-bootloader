...
| 3 | Firmware contract & diagnostics | ✅ done `feat/10-firmware-info` · ✅ done `feat/11-heartbeat-health` · 🔜 planned `feat/12-dtc` · 🔜 planned `feat/13-log-stream` · 🔜 planned `feat/14-live-data` | `v0.3.0-diagnostics` |
