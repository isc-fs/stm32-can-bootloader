...
| 2 | Protocol rewrite (classic CAN) | ✅ done `feat/5-frame-layout` · ✅ done `feat/6-isotp` · ✅ done `feat/7-core-opcodes` · 🔜 planned `feat/8-flash-opcodes` · 🔜 planned `feat/9-session-timeout` | `v0.2.0-protocol` |
